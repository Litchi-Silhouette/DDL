...
double GameMapThree::MOMENTUM = 0.9;
double GameMapThree::ACCELERATION = 0.1; // 1 - momentum
...
void GameMapThree::set_v_player(const int & x_relative,const int & y_relative)
{
    double len = calculate_distance(x_relative,y_relative);

    vx_player = vx_player * MOMENTUM + x_relative / len * PLAYER_V * ACCELERATION;
    vy_player = vx_player * MOMENTUM + y_relative / len * PLAYER_V * ACCELERATION;
