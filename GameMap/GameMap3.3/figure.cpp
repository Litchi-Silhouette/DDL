...
Boss::Boss(GameMap *parent): Figure(parent)
{
    ...
    case 3:
        ...
        resize(MainWindow::CELL_SIZE * 8,MainWindow::CELL_SIZE * 8);
        embed_image(path2);break;
    }
}
...
void Bullet::bullet_adjust_v()
{
    ...
    double base_len = BULLET_BASE_V * BULLET_V_BUFF * v_buff;
...
void Bullet::init_v_pos_img(){
    ...
    if(type == "Reflect"){
        ...
        double len = GameMap::calculate_distance(vx,vy);
        vx = vx / len * BULLET_BASE_V * BULLET_V_BUFF * v_buff;
        vy = vy / len * BULLET_BASE_V * BULLET_V_BUFF * v_buff;
        ...
        double dy = parent_gamemap->pfigure->y() - y;
        double len = GameMap::calculate_distance(dx,dy);
        vx = dx / len * BULLET_BASE_V * BULLET_V_BUFF * v_buff;
        vy = dy / len * BULLET_BASE_V * BULLET_V_BUFF * v_buff;
        ...
        vx = - BULLET_BASE_V * BULLET_V_BUFF * v_buff;
        vy = 0.0;
