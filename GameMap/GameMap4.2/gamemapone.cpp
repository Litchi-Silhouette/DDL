...
int GameMapOne::MIN_KEYEVENT_INTERVAL = 120;
...
void GameMapOne::create_all_taskbuff(){
    ...
    set_taskbuff(hw2);
    hw2->embed_image(":/images/images/task2.png");

    TaskBuff * hw3 = new TaskHomework(this,50,6,"高数",-1,-1);
    set_taskbuff(hw3);

    TaskBuff * hw32 = new TaskHomework(this,77,2,"高数",70500,-1);
    set_taskbuff(hw32);
    hw32->set_explanation("又是高数，想不到吧");

    TaskBuff * hw4 = new TaskHomework(this,18,9,"程设",15000,-1);
    set_taskbuff(hw4);
    hw4->set_explanation("郭神出的题怎么可能这么容易AC");
    hw4->embed_image(":/images/images/task3.png");

    TaskBuff * hw5 = new TaskHomework(this,48,2,"软科",-1,-1);
    set_taskbuff(hw5);
    hw5->set_explanation("软件是什么...我不会...谁来教教我");

    TaskAny * pre1 = new TaskAny(this,29,10,"英语pre","你说没时间准备？玩的就是一个刺激！",":/images/images/task1.png",25000,-1);
    set_taskbuff(pre1);

    TaskBuff * club = new TaskAny(this,29,1,"社团活动","耶终于不用跟线代死磕了",":/images/images/task1.png",-1,-1);
    set_taskbuff(club);

    TaskBuff * report = new TaskAny(this,66,1,"读书报告","来P大也得提升人文素养，整天写代码怎么行",":/images/images/task1.png",-1,-1);
    set_taskbuff(report);
    report->embed_image(":/images/images/task2.png");

    TaskBuff * imgrotation = new TaskAny(this,37,4,"图像旋转作业","很简单嘛^_^毫无难度",":/images/images/task1.png",32000,-1);
    set_taskbuff(imgrotation);
    imgrotation->embed_image(":/images/images/task3.png");

    TaskBuff * soccer = new TaskAny(this,68,10,"北大杯","信科踢光滑？根本没有悬念嘛",":/images/images/task1.png",-1,-1);
    set_taskbuff(soccer);

    TaskBuff * hw6 = new TaskHomework(this,60,2,"AI基础",-1,-1);
    set_taskbuff(hw6);
    hw6->set_explanation("选课不选AI基础，也只能度过一个相对失败的狮生");
    hw6->embed_image(":/images/images/AIbasic.png");


    TaskBuff * sleep1 = new BuffSleep(this,20,6,4200,5000,-1);
    sleep1->set_name("玩原神");
    sleep1->set_explanation("不玩原神，只能度过一个相对失败的狮生（原地停留4秒）");
    sleep1->embed_image(":/images/images/special1.png");
    set_taskbuff(sleep1);

    TaskBuff * sleep2 = new BuffSleep(this,43,4,3600,-1,-1);
    set_taskbuff(sleep2);

    TaskBuff * tired = new BuffTired(this,55,8,10000);
    set_taskbuff(tired);

    TaskBuff * surprise = new BuffSurprise(this,65,8,60000,-1);
    set_taskbuff(surprise);
