...
void GameMapThree::create_all_taskbuff(){
    ...
    TaskBuff * hw1 = new TaskHomework(this,7,8,"概统",-1,30000);
    set_taskbuff(hw1);

    TaskBuff * hw2 = new TaskHomework(this,15,2,"高数",-1,20000);
    set_taskbuff(hw2);

    TaskBuff * hw3 = new TaskHomework(this,2,9,"英语",20000,32000);
    set_taskbuff(hw3);

    TaskBuff * sleep = new BuffSleep(this,0,0,1000,-1,10000);
    sleep->set_explanation("原地停留1秒");
    set_taskbuff(sleep);

    TaskBuff * timemanager = new BuffTimeManager(this,10,7.5,-1,-1,8000);
...
void GameMapThree::create_all_bullets(){
    Bullet * pblt1 = new Bullet(this,"Reflect",pboss,-1,20000);
    set_bullet(pblt1);

    Bullet * pblt12 = new Bullet(this,"Reflect",pboss,15000,40000);
    set_bullet(pblt12);

    Bullet * pblt2 = new Bullet(this,"Trace",pboss,5000,15000);
    set_bullet(pblt2);

    Bullet * pblt3 = new Bullet(this,"Missle",pboss);
    set_bullet(pblt3);

    Bullet * pblt4 = new Bullet(this,"Bomb",pboss);
    set_bullet(pblt4);
