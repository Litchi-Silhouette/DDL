...
public:
    ...
    DDL_Line(GameMap * parent): QLabel((QWidget *)parent){
        ...
        GameMapOne::DDL_LINE_SPEED_PER_S = MainWindow::CELL_SIZE * 0.6;
        speed_per_ms = GameMapOne::DDL_LINE_SPEED_PER_S / 1000.0;
        qDebug()<<speed_per_ms<<" "<<GameMapOne::DDL_LINE_SPEED_PER_S;
