...
void GameMapOne::create_all_taskbuff(){
    ...
    set_taskbuff(hw3);
    TaskBuff * hw32 = new TaskHomework(this,77,2,"高数",72000,-1);
    set_taskbuff(hw32);
    ...
    TaskBuff * sleep1 = new BuffSleep(this,20,6,4000,5000,-1);
    sleep1->set_name("玩原神");
    sleep1->set_explanation("不玩原神，只能度过一个相对失败的狮生（原地停留4秒）");
    sleep1->embed_image(":/images/images/special1.png");
    set_taskbuff(sleep1);

    TaskBuff * sleep2 = new BuffSleep(this,43,4,3500,-1,-1);
    set_taskbuff(sleep2);
